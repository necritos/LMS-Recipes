...
**Integraciones (Firebase, Bunny, Stripe, Mailchimp, Google):** [configurar-integraciones.md](../configurar-integraciones.md) — qué activar en cada dashboard y qué `PATCH` pegar en admin.
