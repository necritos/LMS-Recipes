    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "cover_image",
                    models.ImageField(blank=True, upload_to=apps.catalog.models.cover_upload_path),
                ),
                (
                    "status",
                    models.CharField(
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("timed", "Acceso por tiempo limitado"),
                        ],
                        default="lifetime",
                        max_length=20,
                    ),
            ...
            options={
                ...
                "constraints": [
                    models.UniqueConstraint(
                        fields=("course", "language"), name="uniq_course_translation_lang"
                    )
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "constraints": [
                    models.UniqueConstraint(
                        fields=("category", "language"), name="uniq_category_translation_lang"
                    )
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "constraints": [
                    models.UniqueConstraint(
                        fields=("recipe", "language"), name="uniq_recipe_translation_lang"
                    )
                ],
            },
        ),
